...
export const projects: Project[] = [
    ...
    {
        name: "PetControl",
        description: "O sistema permite cadastrar e gerenciar pets para adoção, com listagem paginada, visualização detalhada e operações de CRUD. A aplicação conta com API REST documentada via Swagger/OpenAPI, integração com front-end em Next.js, testes automatizados, padronização de código e pipeline de CI/CD.",
        linkGithub: "https://github.com/orgs/db-petcontrol/repositories",
        linkDeploy: "https://petcontrol-app.onrender.com/",
        src: "/images/projects/petcontrol.png",
